  ...
  itemContent: ({ context }) => ({
    class: [
      ...
      //'text-surface-700 dark:text-white/80',
      {
        ...
        'text-surface-500 dark:text-white/70 bg-surface-200 dark:bg-[rgba(255,255,255,0.15)]':
      ...
      // States
      {
        'hover:bg-surface-100 dark:hover:bg-[rgba(255,255,255,0.10)]': !context.active,
